...
var module_name = "led_light_interval";
//
...
// interval support, blink led based on incoming value
var interval = null;
var led_interval = 0;
//
// Important, to see debug output, you need to:  export DEBUG=led_light_interval on command line
...
function init(req) {   // TODO PERRY  Need to handle > 1 GPIO pin, e.g could enable several
 ...
 // Assign the information needed for on/off api from the gpio object
  ...
  led_interval = req.gpio_basis.led_pin.led_interval;

  debug("Module [" + module_name + "] init [Mode: " + gpio_mode + " Pin: " + gpio_pin + "Interval: " + led_interval + "]");
