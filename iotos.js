...
app.post(IT_configuration.iotos_root_uri + access_control, function (req, res) {
    ...
    res.send(access_control + " " + req.params.target + ' state information: ' +
...
app.post(IT_configuration.iotos_root_uri + control, function (req, res) {
    ...
    console.log("Client requested resource [" + client_resource + "] directive [" + json_return_data.command + "]");
    ...
    console.log("resource object: " + JSON.stringify(resource_object, null, 4));
    ...
    if ((os_arch == "arm") && (os_platform == "linux")) {
        ...
        debug("Resource Status: " + JSON.stringify(resource_status[resource_basis][resource_instance], null, 4));
                            ...
                            for (var publish_type in resource_basis_publish_targets) {
                                ...
                                switch (publish_type) {
                                    ...
                                    case publish_restful:
                                        ...
                                        resource_object["emitter_restful"].emitter.on(client_resource + "_restful", function (payload) {
                                            restful_url_event_publisher(payload)
                                        });
    ...
    // res.send(control + " " + req.body.target + ' state information: ' + JSON.stringify(json_return_data,null,4));
